  ...
  return (
    <div className="flex flex-col justify-center items-center gap-5 pb-80 max-md:gap-2">
        <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
          ...
          <div className="relative flex space-x-2 items-center z-10 rounded-full dark:bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 max-md:py-[1px] max-md:px-3 ">
            <Sparkles className="w-4 max-md:w-3" />
