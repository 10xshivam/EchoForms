  ...
  return (
    <nav className="fixed top-0 w-full h-16 border-b border-black/10 dark:border-white/10  backdrop-blur-xl items-center flex px-7 justify-between z-50">
      <div className="flex justify-center items-center gap-1">
        ...
        <span className="text-2xl font-bold text-black/70 dark:text-white/70 ">EchoForms</span>
      </div>
      <div className="flex justify-center items-center gap-4">
        <Button className="bg-transparent text-black/90 dark:text-white/90 dark:hover:bg-white/10 border-2 shadow-none hover:border-none border-black/10 hover:bg-black/5 dark:border-white/5 text-md">Sign up</Button>
