...
export default function Navbar() {
  const { user } = useUser();
  return (
    <nav className="fixed top-0 w-full h-16 border-b border-black/10 dark:border-white/10  backdrop-blur-xl items-center flex px-8 justify-between z-50">
        ...
        {!user ? (
          <>
            ...
            <Link
              ...
              className="text-black/60 dark:text-white/70 hover:text-black dark:hover:text-white"
            >
              <Github />
            </Link>
            <ThemeToggle />
