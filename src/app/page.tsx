      ...
      <div className="flex flex-col justify-center items-center gap-10 pb-32">
        ...
        <div className="flex justify-center items-center gap-10">
          {pricingPlans.map((plan) => (
            <div key={plan.name} className="bg-zinc-900/10 dark:bg-zinc-900 p-5 px-7 flex flex-col rounded-xl space-y-2">
              <p className="text-lg tracking-tight font-medium mb-3 text-zinc-700 dark:text-zinc-200/50">{plan.name}</p>
              ...
              <Button className="bg-zinc-700 dark:bg-zinc-400/10 hover:bg-zinc-800 dark:hover:bg-zinc-400/30 text-white !mb-1">{plan.buttonText}</Button>
            </div>
          ))}
        </div>
      </div>
